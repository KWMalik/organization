#ifndef _GROWING_FIXED_ALLOCATOR_H_
#define _GROWING_FIXED_ALLOCATOR_H_

#include <vector>

#include "chunk.h"

/// \class GrowingFixedAllocator
/// \author Toby Banks
/// 
/// A GrowingFixedAllocator is responsible for allocating objects of a given size. 
/// A GrowingFixedAllocator manages 1 or more Chunks of a object of a given size.
/// 
class GrowingFixedAllocator
{
public:
    /// Zero's out all non-static members.
    GrowingFixedAllocator() : m_uiBlockSize(0), m_uiNumberOfBlocks(0), m_pAllocChunk(0), 
    ...
    /// \author Toby Banks
    ///
    /// Initializes a GrowingFixedAllocator by calculating the number of blocks per chunk.
    ///
    /// \brief Causes this GrowingFixedAllocator to create blocks that are blockSize by chunkSize.
    ...
    /// \author Toby Banks
    ///
    /// Frees a block of memory. If this GrowingFixedAllocator doesn't own the block
    ...
    /// \author Toby Banks
    ///
    /// \brief Returns the size this GrowingFixedAllocator was initialized with.
    /// \return The size this GrowingFixedAllocator was initialized with.
...
private:
    /// Not implemented.
    GrowingFixedAllocator(const GrowingFixedAllocator&);

    /// Not implemented.
    GrowingFixedAllocator& operator=(const GrowingFixedAllocator&);
...
///////////////////////////////////////////////////////////////////////////////////////////////
inline const Chunk * GrowingFixedAllocator::HasBlock(void * pointer) const
{
...
///////////////////////////////////////////////////////////////////////////////////////////////
inline Chunk * GrowingFixedAllocator::HasBlock(void * pointer)
{
    return const_cast<Chunk *>(const_cast<const GrowingFixedAllocator *>(this)->HasBlock(pointer));
}

#endif // _GROWING_FIXED_ALLOCATOR_H_
