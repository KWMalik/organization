...
///////////////////////////////////////////////////////////////////////////////////////////////
void StagnantFixedAllocator::Init(unsigned int blockSize, unsigned int chunkSize)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////
void StagnantFixedAllocator::DoDeallocate(void * pointer)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////
unsigned int StagnantFixedAllocator::NumberOfEmptyChunks() const
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
bool StagnantFixedAllocator::MakeNewChunk()
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
Chunk *StagnantFixedAllocator::VicinityFind(void * pointer) const
{
    if(m_pChunks.empty())
    {
        return NULL;
...
///////////////////////////////////////////////////////////////////////////////////////////////
bool StagnantFixedAllocator::TrimEmptyChunk()
{
    Assert(ASSERT_ALL, m_pEmptyChunk == NULL || m_pEmptyChunk->HasAvailable(m_uiNumberOfBlocks));
...
///////////////////////////////////////////////////////////////////////////////////////////////
bool StagnantFixedAllocator::TrimChunkContainer()
{
    if(m_pChunks.empty())
    {
        Assert(ASSERT_ALL, m_pAllocChunk == NULL);
